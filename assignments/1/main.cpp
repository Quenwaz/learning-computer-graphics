...
constexpr double ANGLE_TO_RADIAN= (MY_PI / 180.0);
...
Eigen::Matrix4f get_model_matrix(float rotation_angle)
{
    ...
    const double radian_angle = ANGLE_TO_RADIAN * rotation_angle;
    transform << std::cos(radian_angle),-std::sin(radian_angle), 0,0,
